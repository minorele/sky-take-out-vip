...
import org.cheems.dto.SetmealDTO;
import org.cheems.dto.SetmealPageQueryDTO;
import org.cheems.entity.Dish;
import org.cheems.entity.Setmeal;
import org.cheems.entity.SetmealDish;
import org.cheems.exception.DeletionNotAllowedException;
import org.cheems.exception.SetmealEnableFailedException;
...
import org.cheems.vo.SetmealVO;
            ...
            if (dishList != null && dishList.size() > 0) {
                dishList.forEach(dish -> {
                    if (StatusConstant.DISABLE == dish.getStatus()) {
                        throw new SetmealEnableFailedException(MessageConstant.SET_MEAL_ENABLE_FAILED);
                    }
                });
            }
        }
